...
OUT_CKPT = Path("checkpoints/overfit_tiny.pt")
...
def main():
    ...
    for epoch in range(1, 101):
        ...
        pbar = tqdm(dl, desc=f"tiny e{epoch}", leave=True)
        ...
        if avg_loss < 0.20:
            print("Tiny overfit passed: architecture can memorize 20 examples.")
            break
